...
from core.theme import BG_APP, BG_CARD, BORDE_CARD, COLOR_LEY1, TEXT_MUTED
...
CUSTOM_BLENDER_PATH: Optional[str] = r"C:\Users\VICTUS\AppData\Local\Programs\Blender\blender-5.2.0\blender-5.2.0-windows-x64\blender.exe"
...
class CTkMessageBox(ctk.CTkToplevel):
    ...
    def __init__(self, parent: Optional[ctk.CTk] | ctk.CTkToplevel, title: str, message: str):
        ...
        card = ctk.CTkFrame(self, fg_color=theme.BG_CARD, corner_radius=14, border_width=1, border_color=theme.BORDE_CARD)
        card.pack(padx=24, pady=(0, 24), fill="x")

        ctk.CTkButton(
            card,
            text="Aceptar",
            fg_color=theme.COLOR_LEY1,
            hover_color="#3a6f7f",
