...
from core.theme import COLOR_LEY3, COLOR_LEY3_DARK, COLOR_ACCION, COLOR_REACCION, BG_APP, BG_CANVAS
from core.three_d import abrir_escena_3d, escribir_estado_3d
